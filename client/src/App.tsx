import { Terminal as TerminalIcon, Shield, Cpu, Network, Activity, Lock, AlertTriangle, FileX, Pointer, Menu } from 'lucide-react';
        ...
        <div className="Navbar">
          <div className="relative mb-6 flex items-center justify-between rounded-2xl bg-neutral-800/50 p-3 backdrop-blur-sm">
            <div className="flex items-center space-x-8">
              ...
              {/* for mobile responsiveness - aafiya */}
              <button 
            ...
            <div className="flex items-center space-x-3">
              ...
              <button className="rounded-full bg-emerald-500 px-4 py-1.5 text-sm font-medium text-neutral-900 shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400">
                Try our AI Now
              </button>
            </div>
          </div>
          ...
          style={{
            ...
            <div className='ai-text md:mr-auto'>
              <h1 style={{
                ...
                fontWeight: 'bold',
                color: '#00ff99', // neon greenish color
                width: '100%',
                maxWidth: '500px',
              ...
              Detect phishing links, fraudulent messages, and cyber threats in real time. Get expert insights, 
              report suspicious activities, 
              and stay ahead of evolving scams—all in one secure platform.</h2>

              <div className='ai-button' style={{
                marginTop: '30px',
                marginBottom: '20px',
              }}>
                <button
                ...
                >
                  ...
                  <svg
                    fill="none"
                    viewBox="0 0 24 24"
                    className="sparkle relative w-7 z-10 text-white"
                  >
                    <path
                      className="path"
