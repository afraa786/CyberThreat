...
const CyberBackground = () => {
  return (
    <div className="fixed top-0 bg-black left-0 w-full h-full overflow-hidden z-0">
      {/* Grid Lines */}
      <div className="absolute top-0 left-0 w-full h-full bg-[length:20px_20px] bg-[linear-gradient(90deg,rgba(255,255,255,0.08)_3px,transparent_0px),linear-gradient(rgba(255,255,255,0.08)_3px,transparent_0px)] animate-moveGrid"></div>
