...
const ThreatReportApp = () => {
  ...
  const threatTypes = [
    {
      ...
      name: "Phishing",
      description:
        "Fraudulent attempt to steal credentials or personal information",
    ...
    },
    {
      ...
      example:
        "Phone call pretending to be from IT support asking for passwords",
      severity: "medium",
      icon: "🎭",
    },
    {
  ...
  const steps = [
    {
      ...
      icon: FileText,
      description: "Describe the threat you encountered",
    },
    {
      id: 2,
      title: "Date & Time",
      icon: Calendar,
      description: "When did this threat occur?",
    },
    {
      id: 3,
      title: "Threat Type",
      icon: Shield,
      description: "What type of threat was it?",
    },
    {
      id: 4,
      title: "Location",
      icon: MapPin,
      description: "Where did you encounter this threat?",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      title: "Delay Reason",
      icon: Clock,
      description: "Why are you reporting this now?",
    },
    {
      id: 7,
      title: "URL/Link",
      icon: Link,
      description: "Provide the suspicious URL if applicable",
    },
    {
      id: 8,
      title: "Evidence",
      icon: Camera,
      description: "Upload screenshots or files as evidence",
    },
    {
      id: 9,
      title: "First Steps",
      icon: Footprints,
      description: "What was your immediate response?",
    },
  ];
    ...
    switch (stepIndex) {
      case 0:
        if (!formData.threatDetails.trim()) {
          newErrors.push({
            field: "threatDetails",
            message: "Please describe the threat",
          });
        }
        break;
      case 1:
      ...
      case 3:
        if (!formData.incidentLocation) {
          newErrors.push({
            ...
            message: "Please select where you encountered this threat",
          });
        }
        break;
    }
  ...
  const handleSubmit = async () => {
    ...
    const result = {
      ...
      message:
        "Your threat report has been successfully submitted to our security team.",
      nextSteps: [
  ...
  const ThreatLevelIndicator = () => (
    <div className="relative rounded-2xl bg-neutral-800/50 p-4 mb-6 backdrop-blur-sm border border-neutral-700/50 shadow-2xl">
      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-400 text-xs mt-2">
          {recentReports.toLocaleString()} reports analyzed today
        </p>
      </div>
    </div>
  );
  ...
  const ProgressSteps = () => (
    <div className="relative rounded-2xl bg-neutral-800/50 p-4 backdrop-blur-sm border border-neutral-700/50 shadow-2xl">
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-400/5 to-transparent rounded-2xl"></div>
      <div className="relative z-10">
  ...
  const ThreatTypeCard = ({ threatType, isSelected, onSelect }) => (
    <motion.button
      ...
      className={`relative p-4 rounded-2xl border text-left transition-all duration-300 backdrop-blur-sm shadow-lg ${
        isSelected
          ? "border-emerald-500/50 bg-emerald-500/10 text-white"
          : "border-neutral-700/50 bg-neutral-800/50 text-gray-300 hover:border-neutral-600/50 hover:bg-neutral-800/70"
      }`}
    ...
    <div className="text-center mb-8">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Help protect others by reporting suspicious activities, scams, and
          cyber threats. Your report helps us strengthen our defenses and keep
          everyone safe.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="relative rounded-2xl bg-neutral-800/50 p-6 backdrop-blur-sm border border-neutral-700/50 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 text-sm">
              Threats are analyzed immediately by our security team
            </p>
          </div>
        </div>
    ...
    <div className="max-w-2xl mx-auto text-center">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="bg-neutral-900/50 rounded-xl p-4 mb-6 border border-neutral-600">
          ...
          <button
            onClick={resetForm}
            className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-medium py-3 px-6 rounded-xl transition-all duration-300"
          >
                ...
                >
                  ...
                  <div className="text-center">
                    <motion.button
                      ...
                      className="bg-emerald-600 hover:bg-emerald-500 text-white font-medium py-3 px-8 rounded-xl transition-all duration-300 inline-flex items-center space-x-2"
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                threatDetails: e.target.value,
                              })
                            }
                            placeholder="e.g., I received a suspicious email claiming to be from my bank asking me to verify my account..."
                            className={`w-full bg-neutral-900/50 border rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 transition-all duration-300 ${
                              getFieldError("threatDetails")
                                ? "border-red-500 focus:ring-red-500/20"
                                : "border-neutral-600 focus:border-emerald-500 focus:ring-emerald-500/20"
                            }`}
                            rows={4}
                          />
                          {getFieldError("threatDetails") && (
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                threatDate: e.target.value,
                              })
                            }
                            className={`w-full bg-neutral-900/50 border rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 transition-all duration-300 ${
                            ...
                            {locationOptions.map((option) => (
                              <motion.button
                                ...
                                onClick={() =>
                                  setFormData({
                                    ...formData,
                                    incidentLocation: option.value,
                                  })
                                }
                                className={`relative p-3 rounded-xl border text-left transition-all duration-300 backdrop-blur-sm ${
                                  formData.incidentLocation === option.value
                                    ? "border-emerald-500/50 bg-emerald-500/10 text-emerald-400"
                                    : "border-neutral-600/50 bg-neutral-800/50 text-gray-300 hover:border-neutral-500/50"
                                }`}
                                whileHover={{ scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                              >
                      ...
                      {currentStep === 4 && (
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full bg-neutral-900/50 border border-neutral-600 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all duration-300"
                            rows={3}
                          />
                        </div>
                      )}
                      ...
                      {currentStep === 6 && (
                        <div>
                          ...
                          <p className="text-gray-500 text-xs mt-1">
                            ⚠️ Do not click on suspicious links. Copy and paste
                            the URL here.
                          </p>
                        </div>
                      )}
                      ...
                      {currentStep === 7 && (
                        <div>
                          ...
                          <div className="border-2 border-dashed border-neutral-600 rounded-xl p-8 text-center bg-neutral-900/30">
                    ...
                    <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-700">
                      <motion.button
                        ...
                        className="flex items-center space-x-2 px-6 py-3 bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 disabled:opacity-50 text-white rounded-xl transition-all duration-300 disabled:cursor-not-allowed"
                      ...
                      {currentStep === steps.length - 1 ? (
                        <motion.button
                          ...
                          className="flex items-center space-x-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-600 text-white font-medium rounded-xl transition-all duration-300 disabled:cursor-not-allowed"
                        ...
                        <motion.button
                          onClick={nextStep}
                          className="flex items-center space-x-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-medium rounded-xl transition-all duration-300"
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          <span>Next</span>
                    ...
                    {errors.length > 0 && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="mt-4 p-4 bg-red-900/20 border border-red-500/50 rounded-xl"
                      >
